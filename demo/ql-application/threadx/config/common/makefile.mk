...
#-------------------------------------------------------------------------------
SFLAGS:=-c -mlong-calls  -mcpu=cortex-r5 -mfloat-abi=softfp -mfpu=vfpv3-d16 -mlittle-endian -mthumb -mthumb-interwork  -Wall -Os
CFLAGS:=-c -MMD -mlong-calls  -mcpu=cortex-r5 -mfloat-abi=softfp -mfpu=vfpv3-d16 -mlittle-endian -mthumb -mthumb-interwork  -Wall -ffunction-sections -fdata-sections $(FNO_BUILTIN_FLAGS) -D__OCPU_COMPILER_GCC__ -D_WANT_USE_LONG_TIME_T -std=c99 -g -Os
CPPFLAGS:=-c -MMD -mlong-calls  -mcpu=cortex-r5 -mfloat-abi=softfp -mfpu=vfpv3-d16 -mlittle-endian -mthumb -mthumb-interwork  -Wall -ffunction-sections -fdata-sections $(FNO_BUILTIN_FLAGS) -D__OCPU_COMPILER_GCC__ -D_WANT_USE_LONG_TIME_T -std=c++11  -g -Os
