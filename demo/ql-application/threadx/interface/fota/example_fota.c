...
#define MG_FOTA_SERVER_ADDRESS_STEP1 "http://112.31.84.164:8302/yang/old_new.bin"
//#define MG_FOTA_SERVER_ADDRESS_STEP1 "ftp://112.31.84.164:8309/yang/old_new.bin"
#define MG_FOTA_FTP_SERVER_USERNAME "test"
#define MG_FOTA_FTP_SERVER_PASSWD   "test"
#define MG_PROFILE_IDX 1

void ql_mergefile_minifota_test(void)
{
	int ret = 0;
	fota_exam_log("========== mergefile fota ==========");
	ret = ql_fota_mergefile_mini_system(MG_PROFILE_IDX, QL_FOTA_DWNLD_MOD_HTTP, MG_FOTA_SERVER_ADDRESS_STEP1 ,NULL, NULL,NULL);
	if(ret != 0){
...
//minifotaµ¥°üÉý¼¶
//application_init(ql_mergefile_minifota_test, "ql_mergefile_minifota_test", 10, 2);

#define FOTA_SERVER_ADDRESS_STEP1 "http://112.31.84.164:8302/yang/old_new.bin_1"
#define FOTA_SERVER_ADDRESS_STEP2 "http://112.31.84.164:8302/yang/old_new.bin_2"
